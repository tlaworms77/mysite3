				...
				<div id="content">
					<div id="site-form">
						<form method="post" action="${pageContext.request.contextPath }/admin/main/update" >
							...
							<img id="profile" name="profile" src="${pageContext.request.contextPath }${site.profile }">
							<input type="file" name="profile" value="${pageContext.request.contextPath }${site.profile }">
